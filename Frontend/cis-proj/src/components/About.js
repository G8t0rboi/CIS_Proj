...
function About() {
    return (
        <div>
            <h1>The US Housing Scene And Our Approach To Understanding It</h1>
            ...
            understand what they mean and how they are quantified. All indicators stem from the 
            American Housing Survey, a large scale data collection effort that
            conducts extensive interviews with households across the United States every two years. Each indicator 
            ...
            <li>Resident's Sex: Holds the residents sex (male or female). The value is represented numerically where male is 1 and female is 0. This is done to gain further data insight (i.e. An average sex of 0.4 means that for every 10 people 4 are males) </li> 
